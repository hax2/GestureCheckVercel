  ...
  const copy = {
    en: {
      ...
      consentItems: [
        ...
        "Data collected by this survey: a random session ID, background survey answers, ratings, video assignment metadata, and timestamps.",
        "Direct identifiers: this survey does not ask for your name, email address, postal address, contact details, or free-text personal information.",
    ...
    de: {
      ...
      consentItems: [
        ...
        "Durch diese Umfrage erhobene Daten: eine zufällige Sitzungs-ID, Antworten aus dem Hintergrundfragebogen, Bewertungen, Metadaten zur Videozuweisung und Zeitstempel.",
        "Direkte Identifikatoren: Diese Umfrage fragt nicht nach Namen, E-Mail-Adresse, Postanschrift, Kontaktdaten oder frei eingegebenen personenbezogenen Informationen.",
    ...
    it: {
      ...
      consentItems: [
        ...
        "Dati raccolti da questo sondaggio: un ID sessione casuale, risposte al questionario iniziale, valutazioni, metadati dell'assegnazione dei video e timestamp.",
        "Identificatori diretti: questo sondaggio non chiede nome, indirizzo email, indirizzo postale, contatti o informazioni personali in testo libero.",
