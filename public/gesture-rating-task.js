(function () {
  ...
  const copy = {
    en: {
      ...
      dimensions: [
        ["iconicity", "The gesture visually resembles the meaning of the word."],
        ["sensorimotor_imagery", "The gesture feels like a real action or experience."],
        ["motional_salience_gesture", "The movement is big and dynamic."],
        ["emotional_salience_facial_expression", "The face is conveying intense emotion."],
        ["cultural_familiarity", "This gesture is common in my country."],
        ["enactment_potential", "This gesture would be easy to perform."],
      ],
    },
    de: {
      ...
      dimensions: [
        ["iconicity", "Die Geste ähnelt visuell der Bedeutung des Wortes."],
        ["sensorimotor_imagery", "Die Geste fühlt sich wie eine reale Handlung oder Erfahrung an."],
        ["motional_salience_gesture", "Die Bewegung ist groß und dynamisch."],
        ["emotional_salience_facial_expression", "Das Gesicht vermittelt intensive Emotion."],
        ["cultural_familiarity", "Diese Geste ist in meinem Land verbreitet."],
        ["enactment_potential", "Diese Geste wäre leicht auszuführen."],
      ],
    },
    it: {
      ...
      dimensions: [
        ["iconicity", "Il gesto assomiglia visivamente al significato della parola."],
        ["sensorimotor_imagery", "Il gesto sembra una vera azione o esperienza."],
        ["motional_salience_gesture", "Il movimento è ampio e dinamico."],
        ["emotional_salience_facial_expression", "Il volto trasmette un'emozione intensa."],
        ["cultural_familiarity", "Questo gesto è comune nel mio Paese."],
        ["enactment_potential", "Questo gesto sarebbe facile da eseguire."],
      ],
    },
  };
